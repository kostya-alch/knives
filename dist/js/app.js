(() => {
          ...
          function ae(t, s, o) {
            ...
            function z(e, t) {
              ...
              for (var i = 0; i < s.handles; i++)
                f.push(j(t, i)), (k[i] = i), S.push(q(n, e[i + 1]));
            }
            function H(e) {
              return (
              ...
              return (
                ...
                n.forEach(function (r, a) {
                  ...
                  for (
                    ...
                    for (
                      v = (h = (f = A.toStepping(p)) - d) / (t.density || 1),
                        y = h / (b = Math.round(v)),
                        u = 1;
                      u <= b;
                      u += 1
                    )
                      i[(m = d + u * y).toFixed(5)] = [A.fromStepping(m), 0];
                    (g =
                      n.indexOf(p) > -1
                ...
                if ((a = n ? n(r, a) : a) !== e.PipsType.None) {
                  ...
                  (l.className = u(a, s.cssClasses.marker)),
                    ...
                    a > e.PipsType.NoValue &&
                      (((l = B(o, !1)).className = u(a, s.cssClasses.value)),
            ...
            function fe(e, t) {
              ...
              if ((e.preventDefault(), u || p)) {
                ...
                if (null === g) return !1;
                !1 === g &&
                  (g = A.getDefaultStep(P[t], p, s.keyboardDefaultStep)),
                  (g *=
            ...
            function he(e) {
              e.fixed ||
                ...
                e.tap && se(E.start, c, pe, {}),
                e.hover && se(E.move, c, ue, { hover: !0 }),
                e.drag &&
  ...
  (() => {
    ...
    function E(e, t) {
      ...
      if (y(e) && t) {
        var r = e.offsetHeight,
          a = e.offsetWidth;
        a > 0 && (n = C(s.width) / a || 1), r > 0 && (i = C(s.height) / r || 1);
      }
      return {
        width: s.width / n,
        height: s.height / i,
    ...
    function L(e) {
      return E(A(e)).left + T(e).scrollLeft;
    }
    function P(e) {
    ...
    function B(e) {
      for (var t = v(e), s = V(e); s && N(s) && "static" === P(s).position; )
        s = V(s);
      return s &&
        ...
        : s ||
            (function (e) {
              ...
              if (
                ...
                return null;
              for (var s = _(e); y(s) && ["html", "body"].indexOf(O(s)) < 0; ) {
                var n = P(s);
                if (
                  "none" !== n.transform ||
                  "none" !== n.perspective ||
          ...
          d = {
            ...
            forceUpdate: function () {
              if (!c) {
                ...
                if (ee(t, s)) {
                  (o.rects = {
                    reference: M(t, B(s), "fixed" === o.options.strategy),
                    popper: $(s),
                  }),
                    (o.reset = !1),
                  ...
                  for (var n = 0; n < o.orderedModifiers.length; n++)
                    if (!0 !== o.reset) {
                      ...
                      "function" == typeof r &&
                        (o =
                          r({ state: o, options: l, name: p, instance: d }) ||
                          o);
                    } else (o.reset = !1), (n = -1);
                }
              }
    ...
    function ce(e) {
        ...
        u =
          !0 === d
            ? (function (e) {
                ...
                return { x: C(t * n) / n || 0, y: C(s * n) / n || 0 };
              })(a)
            : "function" == typeof d
            ? d(a)
            : a,
      ...
      if (c) {
        ...
        if (
          ...
          (S = q),
            (g -=
              (p && x.visualViewport ? x.visualViewport.height : E[T]) -
              n.height),
            (g *= l ? 1 : -1);
        if (i === H || ((i === j || i === q) && r === U))
          (w = z),
            (h -=
              (p && x.visualViewport ? x.visualViewport.width : E[O]) -
              n.width),
            (h *= l ? 1 : -1);
      }
      var L,
    ...
    function ye(e, t, s) {
      var n =
          "clippingParents" === t
            ? (function (e) {
                var t = I(_(e)),
                  s = ["absolute", "fixed"].indexOf(P(e).position) >= 0,
                  n = s && y(e) ? B(e) : e;
                return b(n)
                  ? t.filter(function (e) {
                      return (
          ...
          if (r) {
            var M,
              ...
              te = y
                ...
                : W + J + Z + L.mainAxis,
              se = t.elements.arrow && B(t.elements.arrow),
              ne = se
                ? "y" === w
                  ? se.clientTop || 0
                  : se.clientLeft || 0
              ...
              le = N + te - oe,
              ce = Ce(f ? x(V, N + ee - oe - ne) : V, N, f ? S(F, le) : F);
            (E[w] = ce), (k[w] = ce - N);
          }
          if (o) {
            var de,
    ...
    function Ae(e) {
      return [j, z, q, H].some(function (t) {
        return e[t] >= 0;
      });
    }
    var Le = te({
    ...
    function ut(e) {
      ...
      return (
        !0 === e
          ? (t.className = Me)
          : ((t.className = $e), Re(e) ? t.appendChild(e) : pt(t, e)),
        t
      );
    }
    function ft(e, t) {
      Re(t.content)
        ? (pt(e, ""), e.appendChild(t.content))
        : "function" != typeof t.content &&
          (t.allowHTML ? pt(e, t.content) : (e.textContent = t.content));
    }
    function ht(e) {
    ...
    function yt(e, t) {
      var s,
        ...
        y = {
          ...
          show: function () {
            ...
            $(), q(), y.state.isMounted || (S.style.transition = "none");
            if (A()) {
              var r = k(),
                a = r.box,
                l = r.content;
          ...
          hideWithInteractivity: function (e) {
            0;
            P().addEventListener("mousemove", g), qe(vt, g), g(e);
          },
          enable: function () {
            y.state.isEnabled = !0;
          },
      ...
      function ee(e) {
        y.clearDelayTimeouts(), e && _("onTrigger", [y, e]), q();
        var t = M(!0),
          n = T(),
          i = n[0],
          r = n[1];
    ...
    const ps = {
      setBreakpoint: function () {
        ...
        u && s && e.changeDirection(), jt(e.params, l);
      ...
      function c() {
        ...
        if (
          ("fraction" === s.type &&
            ...
            c.find(Ss(s.totalClass)).text(s.formatFractionTotal(p))),
          "progressbar" === s.type)
        ) {
          let t;
        ...
        if (
          ...
          document.querySelector(".main-block__slider") &&
            new bs(".main-block__slider", {
              ...
              on: {
                init: function () {
                  const e = document.querySelector(".fraction-controll__all"),
                    t = document.querySelectorAll(
                      ".slide-main-block:not(.swiper-slide-duplicate)"
                    );
                  e.innerHTML = t.length < 10 ? `0${t.length}` : t.length;
                },
